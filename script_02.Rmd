...
en_fall_2020_raw <- read_excel("raw_data/class_enrollment_summary_by_term_9-17-2020.xlsx", skip = 3, col_names = TRUE)

en_fall_2020 <- en_fall_2020_raw %>% 
  clean_names() %>%
  select(-"course_section_code", -"instructor_full_name", -"grad", -"non_degree", -"x_reg", -"vus", -"employee", -"withdraw", -"total") %>%
  filter(u_grad >= 10) %>%
  drop_na()
...
#ECON 10A (Principles of Economics) has the highest undergraduate enrollment, with 559 undergraduates enrolled.
